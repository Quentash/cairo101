//deployed on 0x0412cd61c02cb1d66107e0c5798480111b319471a6970622d72ac264669bbac9

use starknet::ContractAddress;

#[starknet::interface]
trait IExerciseSolutionToken<TContractState> {
...
mod ExerciseSolutionToken {
    ...
    #[external(v0)]
    impl ExerciseSolutionToken of super::IExerciseSolutionToken<ContractState> {
